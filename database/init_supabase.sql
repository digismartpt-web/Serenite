-- ============================================================
-- Sérénité – Initialisation complète (version Supabase SQL Editor)
-- Colle ce fichier dans SQL Editor → New Query → Run
-- ============================================================
...
INSERT INTO users (id, first_name, last_name, email, phone, birth_date,
...
VALUES
  ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11',
   'Thomas', 'Durand', 'thomas.durand@test.serenite.app', '+336****5678',
   '1985-06-15', 'parent', 'papa', 'separated', 2,
   crypt('1234', gen_salt('bf', 12)),
   'fr', 'ciel', '#EAF3DE', '#27500A', TRUE, TRUE),
  ('b0eebc99-9c0b-4ef8-bb6d-6bb9bd380a22',
   'Marie', 'Durand', 'marie.durand@test.serenite.app', '+336****5432',
   '1987-03-22', 'parent', 'maman', 'separated', 2,
   crypt('1234', gen_salt('bf', 12)),
   'fr', 'lavande', '#EEEDFE', '#3C3489', TRUE, TRUE);

INSERT INTO families (id, parent_a_id, parent_b_id, status, name)
VALUES ('c0eebc99-9c0b-4ef8-bb6d-6bb9bd380a33',
  'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11',
  'b0eebc99-9c0b-4ef8-bb6d-6bb9bd380a22',
  'active', 'Famille Durand');

INSERT INTO children (id, family_id, first_name, birth_date, calendar_color, calendar_color_text, created_by)
VALUES
...
INSERT INTO invitations (family_id, inviter_id, code, token, method, status, expires_at, accepted_by, accepted_at)
VALUES ('c0eebc99-9c0b-4ef8-bb6d-6bb9bd380a33',
  'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11',
...
INSERT INTO consents (user_id, cgu_accepted, data_processing_accepted, children_data_accepted, newsletter_accepted, ip_address)
VALUES
